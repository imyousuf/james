...
/**
 * RecipientList implementation which route the mail to a JMS Queue with the name of 
 * processor.$mailstate
 * 
 * $mailstate is the what get returned by Mail.getState()
 * 
 * If you want to use ActiveMQ as JMS implementation you should use {@link ActiveMQRecipientList}
 * 
 *
 */
