...
public abstract class MailHeaders implements Serializable {
    ...
    public void setDate(Date date) {
        // NOTE: since SimpleDateFormat sucks pretty bad, 
        // this doesn't work as it should (times zones are 
        // a pain in Java! You guys should move from Mountain View
        // sometimes and see what i18n really means :).
