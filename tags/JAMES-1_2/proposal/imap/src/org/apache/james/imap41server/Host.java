...
/**
 * Interface for objects representing a host that has an IMAP4rev1 messaging
 * server. There should be one instance of this class per instance of James.
...
public interface Host {
    /* Probably implemented by org.apache.james.James */
    ...
    * mailboxes on this host.
     ...
     */
    public Mailbox getMailbox(String user, String mailboxName)
     ...
     * @see FolderRecord
     */
    public Mailbox createMailbox(String user, String mailboxName)
     ...
     * not exist locally.
     */
    public Iterator listMailboxes(String username, String referenceName,
    ...
    /**
     * Returns true once the specified Mailbox has been checkpointed.
     ...
     *
     * @param mailbox Mailbox that needs checkpointing
     * @returns true
     */
    public boolean checkpoint(Mailbox mailbox);
