...
public abstract class AbstractRemoteManagerTest extends TestCase {
    ...
    public void testWrongLoginUser() throws Exception {
        ...
        String last = getLastLine(answers);
        assertTrue("Last line does not start with 'Login id:' but with '" + last + "'", last.startsWith("Login id:")); // login
                                                                                                                       // failed,
                                                                                                                       // getting
                                                                                                                       // new
                                                                                                                       // login
    ...
    public void testWrongLoginPassword() throws Exception {
        ...
        answers = readAnswer(2);
        String last = getLastLine(answers);
        assertTrue("Line does not start with 'Login id:' but with '" + last + "'", last.startsWith("Login id:")); // login
                                                                                                                  // failed,
                                                                                                                  // getting
                                                                                                                  // new
                                                                                                                  // login
