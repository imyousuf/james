...
public class JamesOsgiBundleXmlApplicationContext extends OsgiBundleXmlApplicationContext{
    ...
    public JamesOsgiBundleXmlApplicationContext(String[] configurationLocations) {
