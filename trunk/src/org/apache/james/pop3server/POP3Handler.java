...
public class POP3Handler implements Composer, Stoppable, Configurable, Service, TimeServer.Bell, Contextualizable {
    ...
    private boolean parseCommand(String command) {
        ...
        logger.log("Command recieved: " + command, logger.INFO);
...
// FIXME!!!: need to print first "lines" of the message
            ...
            try {
                ...
                logger.log("Some deleted messages were not removed: " + ex.getMessage(), logger.ERROR);
            }
            return false;
        } else {
            out.println("-ERR.");
    ...
    public void stop() {
            // todo
        logger.log("Stop SMTPHandler", logger.ERROR);
    }

    public void destroy() {

        logger.log("Destroy SMTPHandler", logger.ERROR);
    }
