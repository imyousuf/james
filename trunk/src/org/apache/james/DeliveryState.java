...
public class DeliveryState implements Serializable {
    ...
    public DeliveryState() {
        Integer state = new Integer(DEFAULT_STATE);
        hash = new Properties();
    }
    ...
    public DeliveryState(InputStream in) throws IOException {
        ...
        state = new Integer(props.getProperty("state"));
        ...
        throws IOException
    {
        ...
        String addresses = InternetAddress.toString(recipients);
        out.writeObject(addresses);
    }

    private void readObject(java.io.ObjectInputStream in)
    throws IOException, ClassNotFoundException {
        state = (Integer) in.readObject();
        hash = (Properties) in.readObject();
        try {
            String addresses = (String) in.readObject();
            if ( addresses != null) {
                recipients = InternetAddress.parse(addresses);
            }
