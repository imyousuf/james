...
public abstract class AbstractRecipientRewriteTableTest extends TestCase {
    ...
    public void testStoreAndRetrieveRegexMapping() throws org.apache.james.rrt.api.RecipientRewriteTable.ErrorMappingException, RecipientRewriteTableException {
    ...
    protected abstract boolean removeMapping(String user, String domain, String mapping, int type) throws RecipientRewriteTableException;
    ...
    private void removeMapping(String user, String domain, String rawMapping) throws RecipientRewriteTableException {
        if (rawMapping.startsWith(RecipientRewriteTable.ERROR_PREFIX)) {
            ...
            removeMapping(user, domain, rawMapping.substring(RecipientRewriteTable.ALIASDOMAIN_PREFIX.length()), ALIASDOMAIN_TYPE);
        } else {
