...
public class ImportBayesianDataCmdHandler implements CommandHandler{
    private final static String COMMAND_NAME = "IMPORTBAYESIANDATA";
    private CommandHelp help = new CommandHelp("importbayesiandata [file]","import the BayesianAnalysis data from a xml file");
