...
package org.apache.james.experimental.imapserver.encode.imap4rev1.status;
...
public class UntaggedNoResponseEncoder extends AbstractChainedImapEncoder {

    public UntaggedNoResponseEncoder(ImapEncoder next) {
        super(next);
    }
    ...
    protected void doEncode(ImapMessage acceptableMessage,
        ...
        composer.untaggedNoResponse(displayText, responseCode);
    }

    protected boolean isAcceptable(ImapMessage message) {
        return (message instanceof UntaggedNoResponse);
    }
